...
<form method="post" action="{{ route('settings.profile') }}">
    ...
    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
        <label for="inputFirstName" class="control-label">{{ __('settings.profile.first-name') }}</label>
    ...
    <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
        <label for="inputLastName" class="control-label">{{ __('settings.profile.last-name') }}</label>
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        <label for="inputEmail" class="control-label">{{ __('settings.profile.email') }}</label>
